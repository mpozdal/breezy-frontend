...
function Nav() {
	...
	return (
		<div className="w-32 bg-light-panels dark:bg-dark-panels  flex flex-col justify-between items-center py-4">
			<span className=" text-light-alt-text dark:text-dark-text font-bold text-xl md:text-2xl">
			...
			<label className="flex flex-col justify-center items-center">
				...
				/>
				<span className="text-light-alt-text text-sm md:text-md dark:text-dark-alt-text font-bold text-center">
					Dark mode
				</span>
			</label>
		</div>
